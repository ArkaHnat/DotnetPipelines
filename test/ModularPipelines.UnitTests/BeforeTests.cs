...
public class BeforeTests : TestBase
{
	...
	public async Task No_Exception_Thrown_When_Dependent_Module_Present()
	{
		...
		var module2EndTime = module2.EndTime.ToString(formatString);
		var module1StartTime = module1.StartTime.ToString(formatString);
		_ = await Assert.That(module2EndTime).IsLessThanOrEqualTo(module1StartTime);
	}
