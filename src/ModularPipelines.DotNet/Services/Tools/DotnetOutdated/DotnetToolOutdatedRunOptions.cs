...
public record DotnetToolOutdatedRunOptions : DotNetOptions, IDotnetToolOutdatedOptions
{
    ...
    /// <summary>
    /// Gets or sets update only deprecated packages. Can be used together with update-only-vulnerable.
    /// </summary>
    [BooleanCommandSwitch("--update-only-deprecated")]
    public bool? UpdateOnlyDeprecated { get; set; }

    /// <summary>
    /// Gets or sets update only vulnerable packages. Can be used together with update-only-deprecated.
    /// </summary>
    [BooleanCommandSwitch("--update-only-vulnerable")]
    public bool? UpdateOnlyVolnurable { get; set; }

    /// <summary>
    /// Gets or sets update only single package.
    /// </summary>
    [BooleanCommandSwitch("--update-only-single-package")]
    public bool? UpdateOnlySinglePackage { get; set; }
}
