...
public abstract class Module : Module<IDictionary<string, object>>, IModule;
    ...
    internal override Task ExecutionTask
    {
        ...
        get
        {
            lock (_startCheckLock)
            {
                ...
                {
                    ModuleResultTaskCompletionSource.TrySetResult(new SkippedModuleResult<T>(this, SkipResult));
                }
